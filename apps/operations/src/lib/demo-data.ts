...
export const demoOverview: Overview = {
  ...
  gaps: [
    { id: "gap-20250516-001", source: "jetstream", startCursor: 1747487745123000, endCursor: 1747487750123000, reason: "jetstream_disconnect", status: "confirmed", collections: [], detectedAt: iso(74000), updatedAt: iso(70000), discoveredCount: 1982341, processedCount: 0, failedCount: 0, reconciledCount: 0 },
